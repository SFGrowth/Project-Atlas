...
DETECTOR_METADATA = {
    "P-01": {
        ...
        "concept_ids": ["CD-01"],
        "rule_ids": ["R-02", "R-05"],
        "ambiguity_ids": ["AMB-03"],
        "primary_definition": "AMB-03=scalar",
        "allowed_alternatives": ["AMB-03=zone"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-02": {
        ...
        "rule_ids": ["R-11"],
        "ambiguity_ids": [],
        "primary_definition": "pivot-based swing detection",
        "allowed_alternatives": ["fractal-based", "zigzag"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-03": {
        ...
        "concept_ids": ["CD-06"],
        "rule_ids": ["R-07", "R-08", "R-09"],
        "ambiguity_ids": [],
        "primary_definition": "most recent swing extreme in MSU direction",
    ...
    "P-04": {
        ...
        "concept_ids": ["CD-06"],
        "rule_ids": ["R-10"],
        "ambiguity_ids": ["AMB-04"],
        "primary_definition": "AMB-04=sweep-wick",
        "allowed_alternatives": ["AMB-04=sweep-close"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-05": {
        ...
        "name": "detect_csd",
        "concept_ids": ["CD-07"],
        "rule_ids": ["R-12", "R-13", "R-14", "R-15", "R-16", "R-17", "R-18"],
        "ambiguity_ids": ["AMB-01", "AMB-05", "AMB-09"],
        "primary_definition": "AMB-01=csd-window-3, AMB-09=full_range",
        "allowed_alternatives": ["AMB-01=csd-window-1", "AMB-01=csd-window-5", "AMB-09=body_midpoint"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-06": {
        ...
        "concept_ids": ["CD-09d"],
        "rule_ids": [],
        "ambiguity_ids": ["AMB-10"],
        "primary_definition": "three-candle gap: low[N] > high[N-2] (bullish) or high[N] < low[N-2] (bearish)",
        "allowed_alternatives": ["AMB-10=proximal_entry", "AMB-10=distal_entry"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-07": {
        ...
        "name": "detect_smt",
        "concept_ids": ["CD-08"],
        "rule_ids": ["R-25", "R-26", "R-27"],
        "ambiguity_ids": ["AMB-08"],
        "primary_definition": "AMB-08=NQ correlated instrument",
        "allowed_alternatives": ["AMB-08=ES", "AMB-08=YM"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-08": {
        ...
        "rule_ids": ["R-19"],
        "ambiguity_ids": [],
        "primary_definition": "open of bar N+1 after CSD confirmation",
        "allowed_alternatives": [],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
    ...
    "P-09": {
        ...
        "rule_ids": ["R-20"],
        "ambiguity_ids": ["AMB-10"],
        "primary_definition": "AMB-10=fvg_midpoint limit order",
        "allowed_alternatives": ["AMB-10=proximal", "AMB-10=distal"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-10": {
        ...
        "concept_ids": ["CD-10"],
        "rule_ids": ["R-21", "R-22", "R-23", "R-24"],
        "ambiguity_ids": ["AMB-07"],
        "primary_definition": "AMB-07=stop-4tick, R-22=3R target",
        "allowed_alternatives": ["AMB-07=stop-1tick"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
    ...
    "P-11": {
        ...
        "ambiguity_ids": ["AMB-01", "AMB-03", "AMB-04", "AMB-05", "AMB-06", "AMB-07", "AMB-08",
                          "AMB-09", "AMB-10", "AMB-11"],
        "primary_definition": "all AMB primary definitions applied",
        "allowed_alternatives": ["see individual primitives"],
        "lookahead_free": True,
        "deterministic": True,
        "roll_window_aware": False,
        "version": "1.0.0",
